  ...
  return <div className="space-y-5 p-4 md:p-6">
    ...
    {report && s && <>
      ...
      <div className="grid gap-4 xl:grid-cols-2">
        ...
        <p className="mt-2 text-xs text-muted-foreground">Assumes one ticket per new registration, no further fixed expenses, and the income entered above. Defaults to the current one-day price. Group bookings, discounts and two-day passes change this estimate. {s.average_ticket_income !== null && `Income so far averages ${money(s.average_ticket_income)} per ticket, including BGC.`}</p>
